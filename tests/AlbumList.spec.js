...
describe('AlbumList', () => {
  ...
  const markup2 = `
    ...
    const markup3 = `
      <div class="list-item">
        <div class="list-description">
          <p class="list-title">No albums found</p>
        </div>
      </div>`;
    ...
    it('should display a message when no albums are found', () => {
      const element3 = document.createElement('div');
      renderAlbums(data3, element3);

      expect(element3.innerHTML).to.be.eql(markup3);
    });
});
